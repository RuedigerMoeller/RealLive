...
public interface ServerContext {
    ...
    public void send( BasicDsonMsg msg );
    public void request( BasicDsonMsg msg, FCFutureResultHandler res );
    public void reply( BasicDsonMsg req, BasicDsonMsg respons );
